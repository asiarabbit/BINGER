...
void yield(){
	...
	const double x0[] = {2.02, 1.86, 1.7 , 2.03, 2.22, 1.784, 2.036}; // aoz
	const double a[]  = {0.06 , 0.06, 0.06, 0.06, 0.06, 0.06 , 0.06 }; // aoz
	const double y0[] = {1.78 , 1.78, 1.78, 1.28, 1.28, 0.97 , 0.68 }; // dE1
	const double b[]  = {0.18 , 0.18, 0.18, 0.18, 0.18, 0.18 , 0.18 }; // dE1
