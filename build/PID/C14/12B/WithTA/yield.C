...
void yield(){
	...
	const char *nuclLs[] = {"B12", "B11", "B10", "Be10"};
	...
	const double x0[] = {2.41, 2.21, 2.01, 2.52}; // aoz
	const double a[]  = {7.26, 7.26, 7.26, 7.26}; // aoz/100.
	const double y0[] = {1.28, 1.28, 1.28, 0.87}; // dE1
	const double b[]  = {0.15, 0.15, 0.15, 0.15}; // dE1
