...
int main(){
	...
	const double nC9 = 14, nC10 = 120, nC11 = 883, nC12 = 105796, nC12Ori = 114155, nC13 = 0;
	const double nB9 = 0, nB10 = 236, nB11 = 355, nB12 = 4;
	const double nBe6 = 0, nBe7 = 93, nBe8 = 0, nBe9 = 16;
	const double nLi5   = 0;

	// empty TA
	const ExpData N0_n(52500, 0);
	const double nC9_n = 2, nC10_n = 47, nC11_n = 240, nC12_n = 44368, nC12Ori_n = 47847, nC13_n = 0;
