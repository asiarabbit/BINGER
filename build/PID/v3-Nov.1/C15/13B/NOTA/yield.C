...
void yield(){
	...
	const char *nuclLs[] = {"B13", "B12", "B11", "Be11", "Be10", "Be9", "B13R", "B13U"};
	...
	vector<double> x0 = {2.541, 2.364, 2.159, 2.717, 2.450, 2.220}; // aoz
	vector<double> a  = {0.07, 0.07, 0.07, 0.07, 0.07, 0.07}; // aoz
	vector<double> y0 = {1.27, 1.27, 1.27, 0.87, 0.87, 0.87}; // dE1
	vector<double> b  = {0.15, 0.15, 0.15, 0.15, 0.15, 0.15}; // dE1
	// for incNucl_U and incNucl_R //
	double daoz = fabs(x0[0] - x0[1]), ddE1 = fabs(1.73 - 1.28);
	// incNucl_R
