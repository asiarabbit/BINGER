...
int main(){
	...
	const double nC13 = 265, nC14 = 1358, nC15 = 1464, nC16 = 155581, nC16Ori = 163568, nC17 = 0;
	const double nB12 = 228, nB13 = 363, nB14 = 91, nB15 = 144, nB16 = 0;
	const double nBe10 = 255, nBe11 = 54, nBe12 = 50, nBe13 = 0;
	const double nLi8 = 0, nLi9 = 0;

	const ExpData N0_n(82368, 0);
	const double nC13_n = 87, nC14_n = 357, nC15_n = 377, nC16_n = 69072, nC16Ori_n = 73314, nC17_n = 0;
	const double nB12_n = 13, nB13_n = 20, nB14_n = 8, nB15_n = 8, nB16_n = 0;
