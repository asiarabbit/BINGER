...
int main(){
	...
	const ExpData e_dT(0.908074, 0.00459552); // detecting efficiency
	...
	const ExpData N0(190811, 0);
	const ExpData CC(6838, sqrt(6838)); // charge-changing yield
	ExpData NR(3638, sqrt(3638)); // neutron-removal yield
	// make up for geometrical efficiency //
	const ExpData nC14(1358, sqrt(1358)), e_gC14(0.9578, 0.001);
	const ExpData nC13(265, sqrt(265)), e_gC13(0.50, 0.05); // geometrical effciency
	...
	const ExpData N0_n(82368, 0);
	const ExpData CC_n(324, sqrt(324)); // charge-changing yield
	ExpData NR_n(1038, sqrt(1038)); // neutron-removal yield
	// make up for geometrical efficiency //
	const ExpData nC14_n(357, sqrt(357));
	const ExpData nC13_n(87, sqrt(87)); // geometrical effciency
