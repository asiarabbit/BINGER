...
void eff(){
	TFile *f = new TFile("~/pionExp2017/build/O18TA_L1.root", "update"); // 2052 1848 1649 0920
	...
	TCutG *nulCUT = (TCutG*)f->Get("N15"); // nuclide cut
	...
	double eff_Final[2];
//	p[2] = 0.9532; p[3] = 0.0030; // DCR eff for O
//	p[2] = 0.9490; p[3] = 0.0060; // DCR eff for N
//	p[2] = 0.9460; p[3] = 0.0090; // DCR eff for C
	p[2] = 0.9380; p[3] = 0.0015; // DCR eff for B
