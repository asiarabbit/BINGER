...
void yieldC13(){
	...
	const double paoz[3] = {2.15372e+01, 2.17063e+00, 2.60064e-02}; // constant, mean, sigma
...
//	const double bdE1[2] = {1.14198e+00, 2.19480e-01}; // dE1 background
	...
	const double a = 3.*paoz[2], b = 2.45*pdE1[2];
	
	const int n = 100; // number of points for TCutG in the dE1-aoz spectrum
	TCutG *C0 = new TCutG("C13", n); // for selecting 12C
	C0->SetTitle("C13");
	C0->SetVarX("aoz");
	C0->SetVarY("dE1");
	C0->SetFillStyle(100);
