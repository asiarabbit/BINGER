...
void CS_N15(){
	...
	const double N0 = 96535.; // number of total incident particles
	double deltaN = 311.; // target fragment count: N15


	// calculate efficiency
	double p[4]{}; // a temporary array
	double eff_e = 0.888, deff_e = 0.020; // detecting efficiency
	double eff_PU = 1., deff_PU = 0.; // pileUp compensation
