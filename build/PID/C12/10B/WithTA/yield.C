...
void yield(){
	...
	const double x0[] = {2.20, 2.00, 1.75}; // aoz
	const double a[]  = {0.07, 0.07, 0.07}; // aoz
	const double y0[] = {1.24, 1.24, 1.00}; // dE1
	const double b[]  = {0.16, 0.16, 0.16}; // dE1
