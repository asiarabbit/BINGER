...
void yield(){
	...
	const char *nuclLs[] = {"B13", "B12", "B11", "Be11", "Be10", "Be9"};
	...
	const double x0[] = {2.63, 2.45, 2.23, 2.80, 2.52, 2.26}; // aoz
	const double a[]  = {0.07, 0.07, 0.07, 0.07, 0.07, 0.07}; // aoz
	const double y0[] = {1.28, 1.28, 1.28, 0.88, 0.88, 0.88}; // dE1
	const double b[]  = {0.15, 0.15, 0.15, 0.15, 0.15, 0.15}; // dE1
