...
void yield(){
	...
	const char *nuclLs[] = {"C13", "C12", "C11", "B12", "B11", "B10"};
	...
	const double x0[] = {2.17, 2.01, 1.84, 2.42, 2.20, 2.00}; // aoz
	const double a[]  = {6.62, 6.62, 6.62, 6.62, 6.62, 6.62}; // aoz/100.
	const double y0[] = {1.76, 1.76, 1.77, 1.27, 1.28, 1.29}; // dE1
	const double b[]  = {0.17, 0.17, 0.17, 0.17, 0.17, 0.17}; // dE1
