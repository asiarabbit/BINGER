...
int main(){
	...
	const ExpData N0(190531, 0), N0_n(75428, 0);
	const double nC12 = 122, nC13 = 378, nC14 = 507, nC15 = 228, nC16 = 104, nC17 = 3;
	const double nB11 = 367, nB12 = 149, nB13 = 112, nB14 = 3;
	const double nBe8 = 0, nBe9 = 108, nBe10 = 126, nBe11 = 7;
	const double nLi7 = 0, nLi8 = 0, nLi9 = 0;

	const double nC12_n = 3, nC13_n = 20, nC14_n = 41, nC15_n = 13, nC16_n = 6, nC17_n = 0;
	const double nB11_n = 16, nB12_n = 4, nB13_n = 4, nB14_n = 0;
	const double nBe8_n = 0, nBe9_n = 5, nBe10_n = 6, nBe11_n = 0;
	const double nLi7_n = 0, nLi8_n = 0, nLi9_n = 0;
