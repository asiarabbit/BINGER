...
void yield(){
	...
	vector<double> x0 = {2.456, 2.220}; // aoz
	vector<double> a  = {0.08, 0.08}; // aoz
	vector<double> y0 = {0.808, 0.808}; // dE1
	vector<double> b  = {0.13, 0.13}; // dE1
	// for incNucl_U and incNucl_R //
	double daoz = fabs(x0[0] - x0[1]), ddE1 = fabs(1.17 - 0.80);
	// incNucl_R
