...
void O18Compare_C(){
	...
	geC14->SetMinimum(0.); geC14->SetMaximum(100.);
	geC14->SetTitle("260MeV/u ^{12}C(^{18}O, ^{X}C)anything;E [MeV/u];\\sigma\\hbox{ [mb]}");
...
//	lg->AddEntry(geN14, "N14"); geN14->Draw("PLsame");
	lg->AddEntry(geC14, "C14"); geC14->Draw("APLsame");
