...
int main(){
	...
	const ExpData N0(91872, 0), N0_n(42348, 0);
	const double nB11 = 561, nB12 = 968, nB13 = 70449;
	const double nBe9 = 54, nBe10 = 172, nBe11 = 78, nBe12 = 33, nBe13 = 0;
	const double nLi7 = 22, nLi8 = 0, nLi9 = 0;

	const double nB11_n = 170, nB12_n = 342, nB13_n = 33685;
	const double nBe9_n = 2, nBe10_n = 10, nBe11_n = 3, nBe12_n = 2, nBe13_n = 0;
