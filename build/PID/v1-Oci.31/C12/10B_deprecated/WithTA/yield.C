...
void yield(){
	...
	const char *nuclLs[] = {"B11", "B10", "Be7", "B11R", "B11U"};
	...
	vector<double> x0 = {2.20, 2.00, 1.75}; // aoz
	vector<double> a  = {0.07, 0.07, 0.07}; // aoz
	vector<double> y0 = {1.24, 1.24, 1.00}; // dE1
	vector<double> b  = {0.16, 0.16, 0.16}; // dE1
