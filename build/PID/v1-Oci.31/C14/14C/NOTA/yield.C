...
void yield(){
	...
	TFile *f = new TFile("~/pionExp2017/build/C14NOTA.root", "update");
	vector<TCutG *> cutgLs;

	const int n = 100; // number of points for TCutG in the dE1-aoz spectrum
	const char *nuclLs[] = {"C14", "C13", "C12", "B13", "B12", "B11", "B10", "Be10", "Be9", "C14R", "C14U"};
	...
	vector<double> x0 = {2.277, 2.117, 1.955, 2.538, 2.343, 2.154, 1.954, 2.451, 2.220}; // aoz
	vector<double> a  = {0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07};
	vector<double> y0 = {1.713, 1.72, 1.72, 1.258, 1.258, 1.258, 1.258, 0.91, 0.91}; // dE1
	vector<double> b  = {0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17}; // dE1
