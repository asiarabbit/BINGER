...
void yield(){
	...
	TFile *f = new TFile("~/pionExp2017/build/C13TA.root", "update");
	vector<TCutG *> cutgLs;

	const int n = 100; // number of points for TCutG in the dE1-aoz spectrum
	const char *nuclLs[] = {"C13", "C12", "C11", "B12", "B11", "B10", "C13R", "C13U"};
	...
	vector<double> x0 = {2.100, 1.946, 1.790, 2.324, 2.133, 1.948}; // aoz
	vector<double> a  = {6.62, 6.62, 6.62, 6.62, 6.62, 6.62}; // aoz/100.
	vector<double> y0 = {2.588, 2.588, 2.588, 1.912, 1.912, 1.912}; // dE1
	vector<double> b  = {0.255, 0.255, 0.255, 0.255, 0.255, 0.255}; // dE1
