...
int main(){
	...
	const ExpData N0(128787, 0);
	const double nC9 = 2, nC10 = 46, nC11 = 635, nC12 = 101548, nC12Ori = 109038, nC13 = 0;
	const double nB9 = 0, nB10 = 156, nB11 = 249, nB12 = 4;
	const double nBe6 = 0, nBe7 = 52, nBe8 = 0, nBe9 = 16;
	const double nLi5   = 0;

	// empty TA
	const ExpData N0_n(52385, 0);
	const double nC9_n = 0, nC10_n = 21, nC11_n = 165, nC12_n = 42776, nC12Ori_n = 45823, nC13_n = 0;
	const double nB9_n = 0, nB10_n = 25,  nB11_n = 14,  nB12_n = 1;
	const double nBe6_n = 0, nBe7_n = 2,  nBe8_n = 0, nBe9_n = 2;
