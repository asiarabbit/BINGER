...
void cutA0(){
	TFile *f = new TFile("~/pionExp2017/build/rootfile/IMP_old/C16TA.root", "update");
	const double pi = TMath::Pi();

	// ellipse parameter: (x0, y0), a, b
	const double px[3] = {1., 137.45, 0.493};
	const double py[3] = {1., 1.2796, 0.0406};
