 ...
 */
/*--------------------------------------------------------------------------*/
int iniparser_dump_ini(dictionary * d, FILE * f)
{
    int     i ;
    int     nsec ;
    char *  secname ;
    ...
    for (i=0 ; i<nsec ; i++) {
        ...
        if(iniparser_dumpsection_ini(d, secname, f) <0)
        {
            return -2;
        }
    }
...
int iniparser_dump_ini_to_file(dictionary * d, char *ini_name)
{

    if (d==NULL || ini_name==NULL) return -1;
    FILE *f;
    if ((f=fopen(ini_name, "w+"))==NULL) {
 ...
 */
/*--------------------------------------------------------------------------*/
int iniparser_dumpsection_ini(dictionary * d, char * s, FILE * f)
{
    int     j ;
    char    *keym;
    int     secsize ;
    ...
    if (d==NULL || f==NULL) return -1;
    if (! iniparser_find_entry(d, s)) return -2;
...
/*--------------------------------------------------------------------------*/
int iniparser_add_key(dictionary * ini, const char * section , const char * key , const char * val)
{
    char temp[256];
    memset(temp , 0 , sizeof(temp));
    sprintf(temp , "%s:%s" , section , key);
    return iniparser_set(ini , temp , val);
}


/*--------------------------------------------------------------------------*/
int iniparser_add_key_int(dictionary * ini, const char * section , const char * key , const int val)
{
    char temp[32];
    memset(temp , 0 , sizeof(temp));
    sprintf(temp , "%d" ,val);
    return iniparser_add_key(ini , section ,key ,temp  );
}


int iniparser_add_section(dictionary * ini, const char * section)
{
    return iniparser_set(ini ,section ,NULL);
}
