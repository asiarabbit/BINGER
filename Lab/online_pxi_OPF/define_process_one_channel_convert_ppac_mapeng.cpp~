...
////////////////PPAC1X is from 3301
          if(ch_id>=3001&&ch_id<=3032)
           { int ch_id1=ch_id-3000;
...
////////////////PPAC1Y is from 3333
          if(ch_id>=3033&&ch_id<=3064)
           { int ch_id1=ch_id-3032;
             if(ch_id1>=1&&ch_id1<=16)
               { int ch_id2 = ch_id1;
...
////////////////PPAC3X is from 3365
          if(ch_id>=3001+64&&ch_id<=3032+64)
           { int ch_id1=ch_id-3000-64;
             if(ch_id1>=1&&ch_id1<=16)
               { int ch_id2 = ch_id1;
...
////////////////PPAC3Y is from 3397
          if(ch_id>=3033+64&&ch_id<=3064+64)
           { int ch_id1=ch_id-3032-64;
             if(ch_id1>=1&&ch_id1<=16)
               { int ch_id2 = ch_id1;
