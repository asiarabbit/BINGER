// B1PrimaryGeneratorAction.cc -- implementation of the class
...
// create and initialize particle gun
...
// to retrieve envelope box is only to get the envelope dimensions
