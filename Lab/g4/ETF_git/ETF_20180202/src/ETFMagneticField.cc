...
ETFMagneticField::ETFMagneticField()
 : G4MagneticField(), fMessenger(nullptr), fIsUniformMagneticField(true),
...
// DEGBUG // DEBUG // DEBUG //
	// DEBUG
	G4double p[4]{}, B[3]{};
	fIsUniformMagneticField = false;
	LoadMagneticFieldFile("magnetic.txt");
	GetMagneticIntensity(p, B);
	G4cout << "_____________________________________________________" << G4endl;
	G4cout << "____ETFMagneticField::GetMagneticIntensity--DEBUG____" << G4endl;
	G4cout << "bField at (0., 0., 0.): " << "B(" <<
		   G4BestUnit(B[0], "Magnetic flux density") << ", " <<
		   G4BestUnit(B[1], "Magnetic flux density") << ", " <<
		   G4BestUnit(B[2], "Magnetic flux density") << ")" << G4endl;
// DEGBUG // DEBUG // DEBUG //
...
G4bool ETFMagneticField::GetMagneticIntensity(const G4double p[4], G4double *B) const{
	...
	G4bool isOut = false;
	static const G4double BMax = 1.2111*tesla;
