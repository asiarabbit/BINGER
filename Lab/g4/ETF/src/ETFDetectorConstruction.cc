...
//	G4Material *water = nist->FindOrBuildMaterial("G4_WATER");
	// vacuum
	G4Material *vacuum = new G4Material("vacuum", 1., 1.01*g/mole, universe_mean_density, kStateGas, temperature, 1.e-19*pascal);
	...
	const G4double bFieldSizeZ = 1700.*mm;
	const G4ThreeVector dipoPos(); // used as the origin of the lab frame
	G4Material *dipoMat = vacuum; // airLanzhou; // water; // 
	// field environment
