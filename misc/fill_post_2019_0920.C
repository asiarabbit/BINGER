...
//			getchar(); // DEBUG
		...
		static const int indexArr1[] = // for CUTG1
			{6613, 18156, 20779, 31416, 38898, 45553, 57448, 91496, 91895, 93790, 94633, 101521, 111781,
			 119573, 132051, 163727, 175021, 185795};
		static const int indexArr2[] = // for CUTG2
			{8894, 12264, 20983, 27612, 29009, 40655, 45885, 120009, 143165, 143962, 165415, 166105,
			 167871, 169542, 174141, 183029, 184792};
		// to find a match
		bool BINGO = false;
