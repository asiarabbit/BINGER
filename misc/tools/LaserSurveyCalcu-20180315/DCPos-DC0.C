...
int main(){
	...
	const double ZcL = (B0x[2] - A0x[2]) * tL + A0x[2]; // the central Z coordinate
	...
	const double ZcR = (B3x[2] - A3x[2]) * tR + A3x[2]; // the central Z coordinate
	// the central point of the measured plane
	const double Xc = (A0[0]+B0[0]+A3[0]+B3[0])/4.;
	const double Yc = (A0[1]+B0[1]+A3[1]+B3[1])/4.;
	const double Zc = (A0[2]+B0[2]+A3[2]+B3[2])/4.;
	// the yaw angle
	...
	cout << "yaw (A0x->A3x): " << atan(-(A0x[2]-A3x[2])/(A0x[0]-A3x[0]))/DEGREE << endl;
	cout << "yaw (B0x->B3x): " << atan(-(B0x[2]-B3x[2])/(B0x[0]-B3x[0]))/DEGREE << endl;
