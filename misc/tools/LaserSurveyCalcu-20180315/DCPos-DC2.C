...
int main(){
	...
	const double A0[3] = {970.1, 382.26, 5006.06};
	const double A3[3] = {1652.27, 387.52, 4823.5};
	const double B0[3] = {971.4, -367.62, 4998.83};
	const double B3[3] = {1657.02, -361.93, 4821.08};
    // sampling on the surface of the MWDC
	const double A0x[3] = {832.86, 308.36, 5047.09};
	const double A3x[3] = {1792.2, 307.32, 4790.72};
	const double B0x[3] = {833.65, 43.98, 5044.79};
	const double B3x[3] = {1794.44, -32.98, 4788.38};
	...
	cout << "\033[33;1mNominal Position: (1337, 0, 5000) at 15 degree.\033[0m\n";
