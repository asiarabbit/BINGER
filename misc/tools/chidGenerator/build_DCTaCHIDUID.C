...
using namespace std;
typedef int tChId_Ta[2][2][1]; // [DC0-1][X-Y][Cable0]

#include "chId0_DCTa.C" // initialization of chIdU and chIdD
...
s2+="# and is 2.5-or-5.-mm x(y)-wise translated w.r.t. X(Y)2.\n";
s2+="#\n";
...
int main(){
	...
	int len[2][2] = {{1, 1}, {1, 1}};
	tChId_Ta *chId[2] = {&chIdU, &chIdD};
	string mkdir = "mkdir "; char path0[128] = "channelIdTaDC";
