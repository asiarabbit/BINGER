...
int main(){
	...
	offsetGap = 0.7; dcThickness = 132.8; // exclusive to the current DC
//	skewAng = 0. * DEGREE; // exclusive to the current DC
	...
	// DCArrL
	// DC1
	P[1][0][0] = -1024.31; P[1][0][1] = 10.385; P[1][0][2] = 1696.79;
	ang[1][0][0] = -28.1346 * DEGREE; ang[1][0][1] = 0.; ang[1][0][2] = 0.;
	...
	pIn[0] = Ai[0][1][0]; pOut_m[0] = A[0][1][0]; // A0: 0
	pIn[1] = Ai[0][1][1]; pOut_m[1] = A[0][1][1]; // A1: 1
	pIn[2] = Ai[0][1][2]; pOut_m[2] = A[0][1][2]; // A2: 2
	pIn[3] = Ai[0][1][3]; pOut_m[3] = A[0][1][3]; // A3: 3
	pIn[4] = Bi[0][1][0]; pOut_m[4] = B[0][1][0]; //  B0: 4
	pIn[5] = Bi[0][1][1]; pOut_m[5] = B[0][1][1]; //  B1: 5
	pIn[6] = Bi[0][1][2]; pOut_m[6] = B[0][1][2]; //  B2: 6
	pIn[7] = Aif[0][1][2]; pOut_m[7] = Af[0][1][2]; //  Af2: 7
 	pIn[8] = Aif[0][1][3]; pOut_m[8] = Af[0][1][3]; //  Af3: 8
...
//	cout << L(pOut_m[3], pOut_m[8]) - 25.4*2. - 8. << endl; getchar(); // DEBUG
...
//		cout << "iP: " << iP << "\tjP: " << jP << "\tkP: " << kP << "\r" << flush;
	...
	fout << "# __________ ETF -> MWDCArrayL -> MWDC1 __________\n";
	fout << Pm[0] << " \t" << Pm[1] << " \t" << Pm[2] << " \t";
	fout << Am[0] / DEGREE << " \t" << Am[1] / DEGREE << " \t" << Am[2] / DEGREE << " \t67\n";
	fout.close();
