...
//	skewAng = 0. * DEGREE; // exclusive to the current DC
	...
	// DCArrR
	// DC1
	P[1][0][0] = 1039.98; P[1][0][1] = 12.62; P[1][0][2] = 1827.15;
	ang[1][0][0] = 22.6273 * DEGREE; ang[1][0][1] = 0.; ang[1][0][2] = 0.;
...
//	for(int i = 3; i--;){ spanP[i] *= 2.; spanA[i] *= 4.; } // DEBUG
	...
	pIn[0] = Ai[1][1][0]; pOut_m[0] = A[1][1][0]; // A0: 0
	pIn[1] = Ai[1][1][1]; pOut_m[1] = A[1][1][1]; // A1: 1
	pIn[2] = Ai[1][1][2]; pOut_m[2] = A[1][1][2]; // A2: 2
	pIn[3] = Ai[1][1][3]; pOut_m[3] = A[1][1][3]; // A3: 3
	pIn[4] = Bi[1][1][1]; pOut_m[4] = B[1][1][1]; //  B1: 4
	pIn[5] = Bi[1][1][2]; pOut_m[5] = B[1][1][2]; //  B2: 5
	pIn[6] = Bi[1][1][3]; pOut_m[6] = B[1][1][3]; //  B3: 6
...
//		cout << "iP: " << iP << "\tjP: " << jP << "\tkP: " << kP << "\r" << flush;
	...
	fout << "# __________ ETF -> MWDCArrayR -> MWDC1 __________\n";
	fout << Pm[0] << " \t" << Pm[1] << " \t" << Pm[2] << " \t";
	fout << Am[0] / DEGREE << " \t" << Am[1] / DEGREE << " \t" << Am[2] / DEGREE << " \t68\n";
	fout.close();
