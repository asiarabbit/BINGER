...
int main(){
	...
	offsetGap = 0.67; dcThickness = 132.6; // exclusive to the current DC
//	skewAng = 0. * DEGREE; // exclusive to the current DC
	...
	// DCArrR
	// DC2
	P[1][0][0] = 1300.03; P[1][0][1] = 13.33; P[1][0][2] = 2230.82;
	ang[1][0][0] = 22.6157 * DEGREE; ang[1][0][1] = 0.; ang[1][0][2] = 0.;
...
//	for(int i = 3; i--;){ spanP[i] *= 2.; spanA[i] *= 4.; } // DEBUG
	...
	pIn[0] = Ai[1][2][0]; pOut_m[0] = A[1][2][0]; // A0: 0
	pIn[1] = Ai[1][2][1]; pOut_m[1] = A[1][2][1]; // A1: 1
	pIn[2] = Ai[1][2][2]; pOut_m[2] = A[1][2][2]; // A2: 2
	pIn[3] = Ai[1][2][3]; pOut_m[3] = A[1][2][3]; // A3: 3
	pIn[4] = Bi[1][2][1]; pOut_m[4] = B[1][2][1]; //  B1: 4
	pIn[5] = Bi[1][2][2]; pOut_m[5] = B[1][2][2]; //  B2: 5
...
//		cout << "iP: " << iP << "\tjP: " << jP << "\tkP: " << kP << "\r" << flush;
	...
	fout << "# __________ ETF -> MWDCArrayR -> MWDC2 __________\n";
	fout << Pm[0] << " \t" << Pm[1] << " \t" << Pm[2] << " \t";
	fout << Am[0] / DEGREE << " \t" << Am[1] / DEGREE << " \t" << Am[2] / DEGREE << " \t132\n";
	fout << "# __________ ETF -> MWDCArrayR -> TOFWall __________\n"
		 << "1357.53	    0.00	2476.9	   		22.5278		0.00		0.00		196\n\n";
	fout.close();
