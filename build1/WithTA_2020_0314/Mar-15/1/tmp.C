...
void tmp(){
	TFile *f = new TFile("~/pionExp2017/build1/20180708_0153.dat_1.root", "update"); // 0920 0508
...
//	treeTrack->Draw("aoz[0]:TOFWPos[0]>>h(500, -700., 700., 500, 1.4, 3.)", "dsca11==0&&A0&&B0&&C0&&dE1>1.5;TOFWPosX [mm];aoz;", "colbox");
...
//	treeTrack->Draw("t0_1Pos[1]:t0_1Pos[0]>>(500, -60., 60., 500, -60., 60.)", "dsca11==0&&PDCPos[1][1]!=-9999.&&!C0", "col")
	treeTrack->Draw("dE1:aoz[0]>>h(1000, 1.9, 3.5, 500, 0.5, 3.)", "dsca11==0&&A0&&B0&&C0;aoz;dE1 arb.;", "colbox");
...
//	treeTrack->Draw("kTa[0][0]-kTa[1][0]:dx2[0]>>(500, -100., 150., 500, -0.1, 0.1)", "A0&&B0&&C0&&(dE1>1.50)&&dsca11==0&&C14", "col");
//	treeTrack->Draw("kTa[0][0]-kTa[1][0]:dx2[0]>>(500, -100., 150., 500, -0.1, 0.1)", "A0&&!(B0&&C0)&&(dE1>1.50)&&dsca11==0&&C14", "col");
