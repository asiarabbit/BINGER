...
void yield(){
	...
	TFile *f = new TFile("~/pionExp2017/build1/C15NOTA.root", "update");
	vector<TCutG *> cutgLs;
	...
	vector<double> x0 = {2.463, 2.302, 2.140, 1.981, 2.753, 2.558, 2.364, 2.172, 2.000, 2.700, 2.473, 2.235}; // aoz
	vector<double> a  = {0.07, 0.06, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07}; // aoz
	vector<double> y0 = {1.69, 1.69, 1.69, 1.69, 1.27, 1.27, 1.27, 1.27, 1.27, 0.91, 0.91, 0.91}; // dE1
	vector<double> b  = {0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17}; // dE1
	// for Be10U and Be10R //
	double daoz = fabs(x0[0] - x0[1]), ddE1 = fabs(y0[0] - 1.30);
	// Be10R
