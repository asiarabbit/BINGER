...
const char *dE1Cut = "dE1>1.5";

void eff(){
	TFile *f = new TFile("~/pionExp2017/build1/C15NOTA.root", "update"); // 2052 1848 1649 0920
	...
	TCutG *C16Ori = (TCutG*)f->Get("C15Ori");


	string cut0 = "index<486800&&dsca11==0&&A0&&B0&&C0";
	string cut1 = "index<486800&&dsca11==0&&A0&&B0&&C0&&aoz[0]>0.";
//	cut1 += "&&"; cut1 += dE1Cut;
