...
void yield(){
	...
	TFile *f = new TFile("~/pionExp2017/build1/C13TA.root", "update");
	vector<TCutG *> cutgLs;
	...
	vector<double> x0 = {2.103, 1.942, 1.790, 1.634, 2.317, 2.138, 1.938}; // aoz
	vector<double> a  = {0.07, 0.06, 0.07, 0.07, 0.07, 0.07, 0.07}; // aoz/100.
	vector<double> y0 = {2.588, 2.588, 2.588, 2.588, 1.912, 1.912, 1.912}; // dE1
