...
int main(){
	...
	const double nC10 = 5, nC11 = 99, nC12 = 433, nC13 = 49801, nC13Ori = 52662;
	const double nB9 = 0, nB10 = 45, nB11 = 156, nB12 = 109, nB13 = 2, nBe9 = 36, nBe10 = 24;

	const ExpData N0_n(35185, 0);
	const double nC10_n = 7, nC11_n = 38, nC12_n = 161, nC13_n = 30841, nC13Ori_n = 32453;
	const double nB9_n = 0, nB10_n = 3, nB11_n = 10, nB12_n = 13, nB13_n = 2, nBe9_n = 3, nBe10_n = 1;
