...
void tmp(){
	TFile *f = new TFile("~/pionExp2017/build1/C13NOTA.root", "update"); // 0920 0508
...
//	treeTrack->Draw("aoz[0]:TOFWPos[0]>>h(500, -700., 700., 500, 1.4, 3.)", "dsca11==0&&A0&&B0&&C0&&dE1>2;TOFWPosX [mm];aoz;", "colbox");
...
//	B3->Draw("same");
	...
	vector<const char *> nclLs = {"C13", "C13Ori", "C12", "C11", "C10", "B12", "B11", "B10", "C13R", "C13U"};
