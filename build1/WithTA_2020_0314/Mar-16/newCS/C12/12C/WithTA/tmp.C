...
void tmp(){
	TFile *f = new TFile("~/pionExp2017/build1/C12TA.root", "update"); // 0920 0508
...
//	treeTrack->Draw("dE1:dE0+(PDCPos[1][1]*(0.005*dE0-0.0016))>>h(500, -1., 5., 500, -1., 5.)", "dsca11==0&&A0&&B0&&C0;dE0-corrected arb.;dE1 arb.;", "col");
...
//	treeTrack->Draw("dE0+(PDCPos[1][1]*(0.005*dE0-0.0016)):PDCPos[1][1]>>h(500, -50., 50., 500, -0.5, 4.5)", "dsca11==0&&PDCPos[1][1]!=-9999.;PDCPos[1][1] [mm];dE0-corrected arb.;", "col");
	// OFFTA && tofwslit
//	treeTrack->Draw("poz[0]:tof2[0]>>h(500, 62., 70., 500, 1000., 1700.)", "dsca11==0&&A0&&B0&&C0;tof2;poz;", "col");
...
//	treeTrack->Draw("t0_1Pos[1]:t0_1Pos[0]>>(500, -60., 60., 500, -60., 60.)", "dsca11==0&&PDCPos[1][1]!=-9999.", "col");
	treeTrack->Draw("dE1:aoz[0]>>h(500, 1.4, 2.55, 500, 0., 4.5)", "dsca11==0&&A0&&B0&&C0;aoz;dE1 arb.;", "colbox");
...
//	B3->Draw("same");
	...
	vector<const char *> nclLs = {"C12", "C12Ori", "C11", "C10", "B11", "B10", "Be7", "C12R", "C12U"};
