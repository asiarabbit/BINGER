...
void yield(){
	...
	TFile *f = new TFile("~/pionExp2017/build1/C12TA.root", "update");
	vector<TCutG *> cutgLs;
	...
	vector<double> x0 = {1.935, 1.782, 1.636, 2.131, 1.938, 1.709}; // aoz
	vector<double> a  = {0.07, 0.055, 0.07, 0.07, 0.07, 0.07}; // aoz
	vector<double> y0 = {1.757, 1.774, 1.774, 1.272, 1.289, 1.01}; // dE1
