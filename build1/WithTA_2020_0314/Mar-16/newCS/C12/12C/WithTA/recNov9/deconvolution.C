...
int main(){
	...
	const ExpData N0(129077, 0);
	const double nC9 = 14, nC10 = 121, nC11 = 885, nC12 = 105782, nC12Ori = 144170, nC13 = 0;
	const double nB9 = 0, nB10 = 235, nB11 = 354, nB12 = 4;
	const double nBe6 = 0, nBe7 = 94, nBe8 = 0, nBe9 = 16;
	const double nLi5   = 0;

	// empty TA
	const ExpData N0_n(52496, 0);
	const double nC9_n = 2, nC10_n = 47, nC11_n = 241, nC12_n = 44375, nC12Ori_n = 47843, nC13_n = 0;
	const double nB9_n = 0, nB10_n = 28,  nB11_n = 25,  nB12_n = 1;
