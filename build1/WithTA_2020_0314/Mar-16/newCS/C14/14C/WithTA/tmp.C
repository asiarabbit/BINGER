...
void tmp(){
	TFile *f = new TFile("~/pionExp2017/build1/C14TA.root", "update"); // 0920 0508
...
//	treeTrack->Draw("t0_1Pos[1]:t0_1Pos[0]>>(500, -60., 60., 500, -60., 60.)", "dsca11==0&&PDCPos[1][1]!=-9999.", "col");
	treeTrack->Draw("dE1:aoz[0]>>h(500, 1.4, 3.2, 500, 0., 4.5)", "dsca11==0&&A0&&B0&&C0;aoz;dE1 arb.;", "colbox");
...
//treeTrack->Draw("13.*beta2[0]/sqrt(1-beta2[0]*beta2[0])*931.494*cospl>>h(100, 7000., 9500.)", "A0&&B0&&C0&&aoz[0]>0.&&pozpl!=-9999.&&C13", "");
...
//	B3->Draw("same");
	...
	vector<const char *> nclLs = {"C14", "C14Ori", "C13", "C12", "C11", "B13", "B12", "B11", "B10", "Be10", "Be9", "C14R", "C14U"};
