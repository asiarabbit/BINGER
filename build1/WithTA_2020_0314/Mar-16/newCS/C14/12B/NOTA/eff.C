...
const char *dE1Cut = "dE1>1.10";

void eff(){
	TFile *f = new TFile("~/pionExp2017/build1/C14NOTA.root", "update"); // 2052 1848 1649 0920
	...
	TCutG *C16Ori = (TCutG*)f->Get("C14Ori");


	string cut0 = "dsca11==0&&A0&&B0&&C0";
	string cut1 = "dsca11==0&&A0&&B0&&C0&&aoz[0]>0.";
//	cut1 += "&&"; cut1 += dE1Cut;
