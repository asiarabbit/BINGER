...
void yield(){
	...
	TFile *f = new TFile("~/pionExp2017/build1/20180708_0153.dat_0.root", "update");
	vector<TCutG *> cutgLs;
	...
	vector<double> x0 = {2.67, 2.50, 2.33, 2.17, 3.00, 2.80, 2.61, 2.40, 2.21, 3.00, 2.74, 2.51, 2.26}; // aoz
