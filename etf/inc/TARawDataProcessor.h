/**
	\file TARawDataProcessor.h
	\class TARawDataProcessor
	\brief Transform raw binary datafile from PXI crates to rootfile for
	...
	\date Created: 2017/10/10 Last revised: 2018/5/7, SUN Yazhou.
