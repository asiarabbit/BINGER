...
//																				     //
// BINGER/inc/etf/TAMagnet.h														 //
//   TAMagnet.h -- header file for class TAMagnet									 //
...
public:
	// struct to trace a particle
	// unit: mm for (x, y, z), m for rho and Tesla for B
	struct tra_t{
