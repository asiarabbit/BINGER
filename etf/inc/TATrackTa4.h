/**
	...
	\date Created: 2019-09-27 Last revised: 2019-09-27, SUN Yazhou.
...
class TATrackT4 : public TAStuff{
public:
	TATrackTa4(const &name = "", const string &title = "");
	...
	/// x2 - x2p
	virtual double GetDX2() const;
	/// DxTa0(PreTa) - DxTa1(PostTa)
	virtual double GetDxTa() const;
	/// \retval: dx2*dx2 + dxTa*dxTa
	virtual double GetChi2Extra() const{
...
protected:
	...
	virtual void BFGSFit(TATrack2 *trkPreTa, TATrack *trkPostTa, double k2, double b2);
