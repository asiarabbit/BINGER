/**
	\file TAParaManager.h
	\class TAParaManager
	\brief Global parameter manager, a container class. All the parameters
	...
	\date Created: 2017/9/26 Last revised: 2017/10/16, SUN Yazhou.
...
protected:
	...
	/// \param isAddHeader: ReadFileList may be called several times from without, then isAddHeader should be
