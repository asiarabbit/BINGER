...
public:
	...
	virtual void EvalDCArr(unsigned short runId = 0, bool isDCArrR = true);
	static void EvalDCArr(const string &rootfile, DetArr_t *detList, unsigned short runid = 0, bool isDCArrR = true);
protected:
