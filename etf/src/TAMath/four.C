...
//																				     //
// BINGER/inc/etf/TAMath/four.C														 //
//   four.C -- source file for method Dsquare4 and minid2_4							 //
//   Introduction: Definition of function double Dsquare4(...). Linear least square	 //
// method fitting for four points that belongs to three DCs and calculate their		 //
// fitting chi2s.																	 //
//																				     //
...
double Dsquare4(const double *x, const double *y, double &k, double &b, const int *LAYER, double DsqThrePerDot){	
//	cout << "This is Dsqure 4" << endl; // DEBUG
//	getchar(); // DEBUG
...
//			getchar(); // DEBUG
	...
	result1 = dsquare;
//	cout << "dsquare1: " << dsquare << endl; // DEBUG
...
//			getchar(); // DEBUG
	...
	result2 = dsquare;
//	cout << "dsquare2: " << dsquare << endl; // DEBUG
...
double minid2_4(const double *x, const double *y, const double *r, double k, double b, const int *LAYER){
	double temp = 0;
	double d2 = 0.;
	for(int i = 0; i < 6; i++){
		if(i == LAYER[0] || i == LAYER[1] || i == LAYER[2] || i == LAYER[3]){ // X1 of each MWDC // JULY THE FIRST //
