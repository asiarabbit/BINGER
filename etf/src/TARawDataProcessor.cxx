...
//																																							     //
// BINGER/inc/etf/TARawDataProcessor.cxx																						 //
//   TARawDataProcessor.cxx -- source file for class TARawDataProcessor							 //
...
TARawDataProcessor::TARawDataProcessor()
	...
	fIsCheckBunchId = TACtrlPara::Instance()->IsCheckBunchIdAlignment();
	fRunId = 0;
	fIndex0 = 0;
	fIndex1 = INT_MAX;
}
