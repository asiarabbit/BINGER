...
void tTrack::show() const{
	...
	cout << "nu:" << endl;
	for(int x : nu) cout << x << "\t"; cout << endl;
	cout << "LAYER:" << endl;
	for(int x : LAYER) cout << x << "\t"; cout << endl;
	cout << "z:" << endl;
	for(double x : z) cout << x << "\t"; cout << endl;
	cout << "x:" << endl;
	for(double z : x) cout << z << "\t"; cout << endl;
	cout << "t:" << endl;
	for(double x : t) cout << x << "\t"; cout << endl;
	cout << "w:" << endl;
	for(double x : w) cout << x << "\t"; cout << endl;
	cout << "r:" << endl;
	for(double x : r) cout << x << "\t"; cout << endl;
	cout << "chi:" << endl;
	for(double x : chi) cout << x << "\t"; cout << endl;
	cout << "TOF: " << TOF << endl;
